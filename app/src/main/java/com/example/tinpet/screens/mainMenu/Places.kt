...
fun PlacesScreen(
    ...
    val properties by remember {
        mutableStateOf(
            MapProperties(
                mapType = MapType.SATELLITE, isMyLocationEnabled = true
            )
        )
    }
    ...
    Scaffold(topBar = {
        Row(
            ...
            Column {
                Text(
                    "Parques y áreas caninas", fontSize = 16.sp, fontFamily = abrilFatface
                )
                Text(
                    "¡Mantén pulsado para añadir el tuyo!"
                )
            }
            Image(painter = selectedCountry.value.first,
        ...
        Column(
            ...
            if (showDialog) {
                AlertDialog(onDismissRequest = {
                    showDialog = false
                }, title = { Text("Añadir ubicación") }, text = {
                    Column(
                        Modifier
                            .fillMaxWidth()
                            .padding(16.dp),
                        ...
                        Column(
                            ...
                            Row(
                                ...
                                RadioButton(selected = selectedRadioButton.value == 1, onClick = {
                            ...
                            Row(
                                ...
                                RadioButton(selected = selectedRadioButton.value == 2, onClick = {
                            ...
                            Row(
                                ...
                                RadioButton(selected = selectedRadioButton.value == 3, onClick = {
                ...
                }, backgroundColor = MaterialTheme.colors.background, confirmButton = {
                    Button(onClick = {
                        if (title.isEmpty()) {
                            isTitleEmpty = true
                        } else {
